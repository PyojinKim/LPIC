function [lines_final] = extractUniqueLines(lines, cam)
...
removeLineIdx_u = find(lines_final(:,1) > 636 & lines_final(:,3) > 636);
removeLineIdx_v = find(lines_final(:,2) > 476 & lines_final(:,4) > 476);
